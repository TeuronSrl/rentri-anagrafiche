...
class CreateRegistroResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRegistroResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRegistroResponse:
        """Create an instance of CreateRegistroResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRegistroResponse.parse_obj(obj)

        _obj = CreateRegistroResponse.parse_obj({
